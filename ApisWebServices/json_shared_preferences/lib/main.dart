...
import 'package:json_shared_preferences/tele_inicial.dart';
...
class _ConfigPageState extends State<ConfigPage> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: TelaInicial(temaEscuro: temaEscuro, nomeUsuario: nomeUsuario) //passando os valores para a tela inicial
    );
  }
